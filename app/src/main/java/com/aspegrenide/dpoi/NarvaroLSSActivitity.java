...
/*
NärvaroLSS
Kopplar knapp till app. När pers ass och kund möter upp, klickar personal knapp eller drar tagg
Appen läser planerade insatser för en lista av kunder
Insatsen Personlig assistans innehåller planerad datum och länkar till personal
När personlig assistans aktivitet har börjat/är nära att börja, slås sensorvärdet upp och bevakas
Om 2 minuter (konfigurerbart) går utan att sensorn slagit över, går larm
Larmet går till ec och innehåller kund, tid, adress, personal, namn, nummer

Fråga:
 */

public class NarvaroLSSActivitity extends AppCompatActivity implements NarvaroListAdapter.ItemClickListener {
